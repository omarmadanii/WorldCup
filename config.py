...
# ⚠️  Verify against actual draw: fifa.com/worldcup/draw
WC_GROUPS = {
    'A': ['الولايات المتحدة', 'باناما', 'بوليفيا', 'الأوروغواي'],
    'B': ['المكسيك', 'كولومبيا', 'الجزائر', 'اليابان'],
    'C': ['كندا', 'هولندا', 'باراغواي', 'أستراليا'],
    'D': ['البرازيل', 'إسبانيا', 'السعودية', 'التشيك'],
    'E': ['الأرجنتين', 'فرنسا', 'المغرب', 'بولندا'],
    'F': ['ألمانيا', 'إنجلترا', 'السنغال', 'كوريا الجنوبية'],
    'G': ['البرتغال', 'إيطاليا', 'نيجيريا', 'باناما'],
    'H': ['بلجيكا', 'الدنمارك', 'الكاميرون', 'إيران'],
    'I': ['كرواتيا', 'سويسرا', 'تونس', 'كوستاريكا'],
    'J': ['اسكتلندا', 'صربيا', 'غانا', 'العراق'],
    'K': ['هنغاريا', 'جنوب أفريقيا', 'إكوادور', 'هندوراس'],
    'L': ['أوكرانيا', 'النمسا', 'مصر', 'نيوزيلندا'],
}
